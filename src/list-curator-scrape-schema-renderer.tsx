...
// "scrape-schema-review") with strict ID matching — the host resolves this
// migrated component through the generated field-renderer component map keyed
// by the binding id (@cinatra-ai/list-curator-agent:scrape-schema-review).
...
export default ListCuratorScrapeSchemaRenderer;
